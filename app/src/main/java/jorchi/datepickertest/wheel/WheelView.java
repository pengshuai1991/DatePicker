...
package jorchi.datepickertest.wheel;
...
import jorchi.datepickertest.MeasureUtil;
import jorchi.datepickertest.R;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff3f51b4;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xffb6b6b6;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x803f51b4,0x803f51b4, 0xff3f51b4 };

	/** Additional items height (is added to standard text item height) */
	private static final int ADDITIONAL_ITEM_HEIGHT = MeasureUtil.dip2px(15);

	/** Text size */
	private static final int TEXT_SIZE = MeasureUtil.dip2px(14);
	...
	private void drawShadows(Canvas canvas) {
		topShadow.setBounds(0, getHeight()*2/visibleItems-ADDITIONAL_ITEM_HEIGHT/2, getWidth(),getHeight()*2/visibleItems-ADDITIONAL_ITEM_HEIGHT/2+2);
		topShadow.draw(canvas);

		//TODO 
		bottomShadow.setBounds(0, getHeight() - getHeight() *2/ visibleItems-2-ADDITIONAL_ITEM_HEIGHT/2,
				getWidth(), getHeight()-getHeight()*2/visibleItems-ADDITIONAL_ITEM_HEIGHT/2);
